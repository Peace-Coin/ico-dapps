...
export default class Ethereum extends Component {
  ...
  onChangeByAmount(e) {
    ...
    if(isFinite(eth) && eth != ''){
      ...
      totalPce = String(totalPce).replace(
        /(\d)(?=(\d\d\d)+(?!\d))/g,
        '$1,'
      )
  ...
  render() {
    ...
    return(
      <div class="modaal-wrapper modaal-inline  l-content_modal--buyCoin l-content_modal--buyCoin-buyEth l-content--form themeB" id="modaal_1528166599473a836644f6c89e">
          ...
          <div class="modaal-inner-wrapper">
            <div class="modaal-container">
              <div class="modaal-content modaal-focus" aria-hidden="false" aria-label="Dialog Window (Press escape to close)" role="dialog" tabindex="0">
                <div class="modaal-content-container" style={{verticalAlign: 'top'}}>
                  <h2 class="tab_content title_content title_content__a title_content__a-modal title_content-ethereum">Buy using Ethereum</h2>
                  <form id="form_buyEthereum">
                  <div style={{display: 'inline-block', verticalAlign: 'top'}} class="form-group form-group--text form-group--text-amount">
                      <label for="frmAmount" class="main">Amount ETH</label>
                      <input
                    ...
                    <div style={{display: 'inline-block', verticalAlign: 'top'}} class="l-content--buyCoin l-content--buyCoin-rate l-content--buyCoin-ethrate clearfix">
                    ...
                    <div class="l-content--buyCoin l-content--buyCoin-token">
                      <h3 class="title_content title_content__a title_content-buyCoin-token">Token</h3>
                    ...
                    <div class="l-content--buyCoin l-content--buyCoin-gasSet clearfix">
                      <div class="l-content--buyCoin l-content--buyCoin-gas l-content--buyCoin-gaslimit">
                        <h3 class="title_content title_content__a title_content-buyCoin-gaslimit">Gas limit</h3>
                        <p class="coin coin-gas">
                          <span class="num coin__num">{this.state.gasLimit}</span>
                        </p>
                      </div>
                      <div class="l-content--buyCoin l-content--buyCoin-gas l-content--buyCoin-gasprice">
                        <h3 class="title_content title_content__a title_content-buyCoin-gasprice">Gas Price</h3>
                        <p class="coin coin-gas">
                          <span class="num coin__num">{this.state.gasPrice}</span>
                    ...
                    <div class="l-sec sec_btnSet sec_btnSet--modal sec_btnSet--modal-buyCoin">
                      <div class="form-group form-group--btn form-group--btn-buyCoin clearfix">
                        <div class="l-content--buybtnSet__item l-content--buybtnSet__item-L borderBox">
                          ...
                          <input class="btn btn--cl-1 btn--size-1" type="button" name="action" value="myetherwallet" />
                          </a>
                        </div>
                        <div class="l-content--buybtnSet__item l-content--buybtnSet__item-R borderBox">
                          <input class="btn btn--cl-1 btn--size-1" type="button" onClick={this.buyToken} name="action" value="metamask" value="Metamask" />
                        </div>
                      </div>
                    </div>
                    </form>
              ...
              <button style={{border: '1px solid grey'}} onClick={this.props.close} type="button" class="modaal-close" id="modaal-close" aria-label="Close (Press escape to close)">
                <span>Close</span>
              </button>
            </div>
          </div>
