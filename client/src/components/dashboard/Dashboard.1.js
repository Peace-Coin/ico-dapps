                        ...
                        >
                          ...
                          >
                            <h2
                              ...
                              class="tab_content title_content title_content__a title_content__a-modal title_content-ethereum"
                            >
                              Buy using BITCOIN
                            </h2>
                            ...
                            <h3
                              ...
                              class="title_content title_content__a title_content__a-modal title_content-smartContract"
                            >
                              Payment Address <br /> (Peace Coin BITCOIN Wallet
                              Address)
                            </h3>
                            <span class="address">
                      ...
                      <div class="modaal-container">
                        ...
                        >
                          <div class="modaal-content-container">
                            ...
                            <p class="text">{this.state.errorMessage}</p>
                          </div>
                        </div>
                        <button
                          style={{ border: '1px solid grey' }}
                      ...
                      <div class="modaal-container">
                        ...
                        >
                          <div class="modaal-content-container">
                            ...
                            <p class="text">{this.state.infoMessage}</p>
                          </div>
                        </div>
                        <button
                          style={{ border: '1px solid grey' }}
