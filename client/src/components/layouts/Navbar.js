...
class Navbar extends Component {
    ...
    if (this.props.authenticated) {
      ...
      return (
        <li className="nav-item">
          ...
          <NavLink to="/dashboard/profile">KYC/AML</NavLink>
  ...
  render() {
    ...
    let userName = (
      <span className="text">{handleName}</span>
    );
      ...
      <nav>
        ...
        <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,700" rel="stylesheet" />
          <div id="header" role="banner">
            <h1 className="logo">
              <a href="#">
                <svg version="1.1" id="logo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 957.8 193" style={{enableBbackground: 'new 0 0 957.8 193'}} xmlSpace="preserve">
                  <g id="set">
                  	<g id="text">
                  		<g>
                  			<path className="st0" d="M234.8,53.9c0-1.3,1-2.4,2.4-2.4h29c15.7,0,28.6,12.8,28.6,28.2c0,15.8-12.9,28.8-28.5,28.8h-18.5v29.6
                  				...
                  				v32H265.6z"></path>
                  			<path className="st0" d="M307.8,53.9c0-1.3,1-2.4,2.4-2.4h51.1c1.4,0,2.4,1.1,2.4,2.4v7.1c0,1.3-1,2.4-2.4,2.4h-40.6v26h34.6
                  				c1.3,0,2.4,1.1,2.4,2.4v7.9c0,1.5-1.2,2.6-2.5,2.6h-34.5v27h40.6c1.4,0,2.4,1.1,2.4,2.4v6.2c0,1.3-1,2.4-2.4,2.4h-51.1
                  				c-1.4,0-2.4-1.1-2.4-2.4V53.9z"></path>
                  			<path className="st0" d="M376.2,138.2l39.3-86.3c0.4-0.8,1.5-1.4,2.2-1.4h1.3c0.6,0,1.8,0.6,2.2,1.4l39.1,86.3
                  				c0.8,1.7-0.3,3.3-2.2,3.3h-8.9c-1.5,0-2.4-0.7-2.9-1.9l-7.8-17.1h-40.9c-2.5,5.7-5.1,11.4-7.6,17.1c-0.4,0.9-1.4,1.9-2.9,1.9
                  				h-8.9C376.4,141.5,375.4,139.8,376.2,138.2z M434.2,110.5l-15.7-35h-0.6l-15.6,35H434.2z"></path>
                  			<path className="st0" d="M510,50.5c12.9,0,22.2,4.3,30.9,11.9c1.2,1,1.2,2.6,0.1,3.6l-5.6,5.8c-0.9,1.2-2,1.2-3.2,0
                  				c-6-5.2-14.2-8.6-22.1-8.6c-18.3,0-32.1,15.3-32.1,33.2s13.9,33.1,32.2,33.1c9.3,0,15.8-3.7,22-8.4c1.2-0.9,2.3-0.8,3.1-0.1
                  				l5.9,5.8c1,0.9,0.8,2.6-0.1,3.5c-8.7,8.4-19.7,12.4-31.1,12.4c-25.6,0-46.1-20.3-46.1-45.9C463.8,71.1,484.4,50.5,510,50.5z"></path>
                  			<path className="st0" d="M558.8,53.9c0-1.3,1-2.4,2.5-2.4h52.1c1.4,0,2.4,1.1,2.4,2.4v7.1c0,1.3-1,2.4-2.4,2.4h-40.6v26h33.6
                  				c1.3,0,2.4,1.1,2.4,2.4v7.9c0,1.5-1.1,2.6-2.4,2.6h-33.6v27h40.6c1.4,0,2.4,1.1,2.4,2.4v6.2c0,1.3-1,2.4-2.5,2.4h-52.1
                  				c-1.4,0-2.5-1.1-2.5-2.4V53.9z"></path>
                  		</g>
                  		<g>
                  			<path className="st1" d="M700,50.5c12.9,0,22.2,4.3,30.9,11.9c1.1,1,1.1,2.6,0.1,3.6l-5.6,5.8c-0.9,1.2-2,1.2-3.2,0
                  				c-6-5.2-14.2-8.6-22.1-8.6c-18.3,0-32.1,15.3-32.1,33.2s13.9,33.1,32.2,33.1c9.3,0,15.8-3.7,22-8.4c1.2-0.9,2.3-0.8,3.1-0.1
                  				l5.9,5.8c1,0.9,0.8,2.6-0.1,3.5c-8.7,8.4-19.7,12.4-31.1,12.4c-25.6,0-46.1-20.3-46.1-45.9C653.9,71.1,674.4,50.5,700,50.5z"></path>
                  			<path className="st1" d="M786.1,50.5c25.6,0,46,20.6,46,46.1c0,25.6-20.4,45.9-46,45.9c-25.6,0-45.9-20.3-45.9-45.9
                  				C740.3,71.1,760.6,50.5,786.1,50.5z M786.1,129.7c18.3,0,33.2-14.8,33.2-33.1c0-18.1-15-33.4-33.2-33.4
                  				C768,63.3,753,78.5,753,96.6C753,114.9,768,129.7,786.1,129.7z"></path>
                  			<path className="st1" d="M850.3,51.5h8.1c1.3,0,2.4,1.1,2.4,2.4v84.1c0,1.3-1.1,2.4-2.4,2.4h-8.1c-1.3,0-2.4-1.1-2.4-2.4V53.9
                  				C847.8,52.6,848.9,51.5,850.3,51.5z"></path>
                  			<path className="st1" d="M883.8,52.8c0-1.3,1-2.3,2.3-2.3h3l55.3,64h0.4V53.9c0-1.3,1-2.4,2.4-2.4h8.2c1.3,0,2.4,1.1,2.4,2.4v86.3
                  				c0,1.3-1,2.3-2.3,2.3h-3.4l-55.2-66h-0.1v62.6c0,1.3-1,2.4-2.4,2.4h-8.1c-1.3,0-2.4-1.1-2.4-2.4V52.8z"></path>
                  		</g>
                  	</g>
                  	<g id="face">
                  		<path className="st1" d="M96.5,0C43.2,0,0,43.2,0,96.5S43.2,193,96.5,193c53.3,0,96.5-43.2,96.5-96.5S149.8,0,96.5,0z M96.5,9.8
                  			...
                  			c5.6-3,16.3-9.9,24.8-17.5C167.9,149.6,153.4,164.9,135.3,174z"></path>
                  		<path className="st1" d="M96.8,112.3c46.3,0,59.3-26.7,59.8-27.8c0.7-1.4,0.1-3.2-1.4-3.9c-1.4-0.7-3.2-0.1-3.9,1.4
                  			c-0.1,0.2-12,24.5-54.6,24.5C54.4,106.5,42.7,83,42.2,82c-0.7-1.4-2.4-2.1-3.8-1.4c-1.4,0.7-2.1,2.4-1.4,3.9
                  			C37.5,85.6,50.5,112.3,96.8,112.3z"></path>
                  		<path className="st1" d="M68.7,57c5.2-0.5,9.1-4.7,8.7-9.5c-0.4-4.8-5-8.3-10.2-7.8c-5.2,0.5-9.1,4.7-8.7,9.5
                  			C58.9,53.9,63.5,57.4,68.7,57z"></path>
                  		<path className="st1" d="M124.3,57c5.2,0.5,9.8-3.1,10.2-7.8c0.4-4.8-3.5-9-8.7-9.5c-5.2-0.5-9.8,3.1-10.2,7.8
                  			C115.2,52.3,119.1,56.5,124.3,57z"></path>
                  	</g>
                  </g>
                </svg>
              </a>
            ...
            <div onClick={this.toggleLang} className="l-selector l-selector--left  l-selector--lang">
              <div className={this.state.langStatus1}>
                <svg className="ico-svg lang">
                  <use xlinkHref="/symbol-defs.svg#icon-lang"></use></svg><span className="text">English</span><svg className="ico-svg angle"><use xlinkHref="/symbol-defs.svg#icon-angle">
                  </use>
                </svg>
              </div>
              <div className={this.state.langStatus2}>
                <ul>
                  <li className="current"><span className="text">English</span></li>
                  <li><a href="#" className="text">Japanese</a></li>
                </ul>
              </div>
            </div>
            <div onClick={this.toggleMenu} className="l-selector l-selector--right  l-selector--user">
